                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-subtotal">Giá khuyến mãi</th>
                                            <th class="product-price">Màu</th>
                                            <th class="product-remove">Dung lượng</th>
                                            <th class="product-quantity">Số lượng</th>
                                            <!-- <th class="product-remove">Tổng tiền</th> -->
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="product-details.html"><img src="./images/product/<?=$cart['product_image']?>" alt=""></a></td>
                                            <td class="product-name"><a href="product-details.html"><?=$cart['product_name']?></a>
                                            </td>
                                            <td class="product-price"><span class="amount"><?=number_format($cart['product_variant_sale_price'] * 1000)?>đ</span></td>
                                            <td class="product-price"><span class="amount"><?=number_format($cart['product_variant_price'] * 1000)?>đ</span></td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="xc-product-quantity mt-10 mb-10">
                                                    ...
                                                    <input class="xc-cart-input" type="text" value="<?=$cart['quantity']?>" >
                                                    <span class="xc-cart-plus add">
                                                        <i class="fas fa-plus"></i>
                                                    </span>
                                                </div>
                                            </td>
                                            <!-- <td class="product-subtotal"><span class="amount"><?=number_format($cart['product_variant_sale_price'] * 1000)?>đ</span></td> -->
                                            <td class="product-remove"><button type="submit"><i class="fa fa-times"></i></button></td>
                                        </tr>
                            ...
                            <div class="shop_cart_widget xc-accordion">
                                <div class="accordion" id="shop_size">
                                    <div class="accordion-item">
                                        ...
                                        <div id="size_widget_collapse" class="accordion-collapse collapse show" aria-labelledby="size__widget" data-bs-parent="#shop_size" style="">
                                            <div class="accordion-body">
                                                ...
                                                <div class="cart-totails">
                                                    <h4>tổng tiền</h4>
                                                    <h4><?=number_format($sum * 1000)?>đ</h4>
                                                </div>
