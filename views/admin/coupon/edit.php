                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                        <form action="?act=coupon-edit&coupon_id=<?=$coupon['coupon_id'] ?>" class="theme-form theme-form-2 mega-form" method="post">
                                            <div class="row">
                                                <div class="mb-4 row align-items-center">
                                                    <label
                                                        class="form-label-title col-lg-2 col-md-3 mb-0"> Tên giảm giá </label>
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="text" name="name" value="<?=$coupon["name"]?>">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="coupon_type" value="percentage" <?= $coupon["coupon_type"] == "percentage" ? "checked" : "" ?> id="flexCheckDefault2">
                                                            <label class="form-label-title col-md-4 mb-0">Giảm theo phần trăm</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="coupon_type" value="fixed amount" <?= $coupon["coupon_type"] == "fixed amount" ? "checked" : "" ?> id="flexCheckDefault3">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="active" <?= $coupon["status"] == "active" ? "checked" : "" ?> id="flexCheckDefault1">
                                                            <label class="form-label-title col-md-4 mb-0">Còn hạn</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="hidden" <?= $coupon["status"] == "hidden" ? "checked" : "" ?> id="flexCheckDefault2">
                                                            <label class="form-label-title col-md-4 mb-0">Hết hạn</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="future plan" <?= $coupon["status"] == "future plan" ? "checked" : "" ?> id="flexCheckDefault3">
                                                ...
                                                <div class="d-flex justify-content-center mt-4">
                                                    <button class="btn btn-danger ps-5 pe-5 me-3" type="submit" name="updateCoupon">Chỉnh sửa giảm giá</button>
