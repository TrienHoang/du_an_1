                                            ...
                                            <div class="row">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="text" name="name" value="<?=$coupon["name"]?>" readonly>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="text" name="coupon_code" value="<?=$coupon["coupon_code"]?>" readonly>
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="coupon_type" value="percentage" disabled <?= $coupon["coupon_type"] == "percentage" ? "checked" : "" ?> id="flexCheckDefault2">
                                                            <label class="form-label-title col-md-4 mb-0">Giảm theo phần trăm</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="coupon_type" value="fixed amount" disabled <?= $coupon["coupon_type"] == "fixed amount" ? "checked" : "" ?> id="flexCheckDefault3">
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="text" name="coupon_value" value="<?=$coupon["coupon_value"]?>" readonly>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="date" name="start_date" value="<?=$coupon["start_date"]?>" readonly>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="date" name="end_date" value="<?=$coupon["end_date"]?>" readonly>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="number" name="quantity" value="<?=$coupon["quantity"]?>" readonly>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="active" disabled <?= $coupon["status"] == "active" ? "checked" : "" ?> id="flexCheckDefault1">
                                                            <label class="form-label-title col-md-4 mb-0">Còn hạn</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="hidden" disabled <?= $coupon["status"] == "hidden" ? "checked" : "" ?> id="flexCheckDefault2">
                                                            <label class="form-label-title col-md-4 mb-0">Hết hạn</label>
                                                        </div>
                                                        <div class="form-check user-checkbox ps-0">
                                                            <input class="checkbox_animated check-it" type="radio" name="status" value="future plan" disabled <?= $coupon["status"] == "future plan" ? "checked" : "" ?> id="flexCheckDefault3">
